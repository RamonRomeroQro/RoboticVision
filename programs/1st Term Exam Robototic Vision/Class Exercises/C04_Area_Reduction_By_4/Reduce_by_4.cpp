...
void userdefined ()
{
	...
	unsigned char TMatrix[256][256];  // Tranformed matrix
    int col,row;
	...
	// Transform a 512 x 512 matrix into a 256 x 256 matrix
	// effectively reducing its size by 4
	for (row=0; row<256; row++)
    	for (col=0; col<256; col++){
    		TMatrix[col][row]=Matrix[col*2][row*2];
		}
