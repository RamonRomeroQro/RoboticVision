...
//        and converts it into a binary image in *.pgm format
//        making pixels greater than 127 white and by
//        making pixels lower or equal than 127 black
//
//------------------------------------------------------------------------------
...
//     binary();                convert original image to binary
...
void openfiles(void)
{
  ...
  scanf("%s",&infile);
  printf(" Enter name of *.pgm OUTPUT image file (example: lenabin.pgm ? ");
  scanf("%s",&outfile);
...
//------------------------------------------------------------------------------
//-----------------------------Obtain binary image------------------------------
//--------------------making pixels greater than 127 white----------------------
//-------------and by making pixels lower or equal than 127 black---------------
//------------------------------------------------------------------------------
void binary()
{
